...
loom {
    forge {
        ...
        mixinConfig(
            "noophaestus-common.mixins.json",
            "noophaestus-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("noophaestus.apply-datagen-mixin", "true")
                property("noophaestus.$platform-datagen", "true")
            }
        }
    }
}

noophaestusModDependencies {
