...
loom {
    ...
    accessWidenerPath = project(":Common").file("src/main/resources/noophaestus.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: noophaestus-common-Common-refmap.json
        // fixed:   noophaestus-common.refmap.json
