...
abstract class NoophaestusModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<NoophaestusModDependenciesExtension>("noophaestusModDependencies")
